...
SECRET_KEY = 'django-insecure-v!+bfdy4=9&y7h-5xiir_@mt#($i)#ja)n)5wyl)c45h4el$&x'
DEBUG = True
ALLOWED_HOSTS = ['*']
INSTALLED_APPS = [
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # asosiy templates papkasi
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'timeout': 30,  # 30 soniya (standart 5 soniya)
        }
    }
}
